...
export type VaultPropertyValue = string | number | boolean | string[] | null
...
export interface VaultEntry {
  ...
  sort: string | null
  /** Default view mode for the note list of this Type: "all", "editor-list", "editor-sidebar", or "editor-only". */
  view: string | null
...
export type SidebarFilter = 'labHome' | 'all' | 'archived' | 'changes' | 'pulse' | 'inbox' | 'favorites'
